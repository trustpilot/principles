...
A context may also optionally expose events to notify downstream systems that something has happened.
...
Take responsibility for your products, internal and external, their artifacts and their service quality. Ensure good observability of your products, know the state of your services and when they need attention. You are responsible for keeping the products healthy and for knowing what that takes. You should also have a handle on the costs associated with running your products in the Cloud. 

*We do this because the people that build the services know them best. We are responsible for what we produce and we're proud of the work we deliver. This includes code quality, testing, documentation, infrastructure, monitoring, alerting, availability, cost and disaster recovery.*
